...
const Nav = () => {
    ...
    return (
        <div className="navbar flex fixed bg-base-100 shadow-lg px-4 z-10">
            <Link to='/' className="flex-1 gap-0 btn border-none text-2xl normal-case text-secondary">
               Byte<span className="text-primary">Blaze</span>
            </Link>
            <div className="flex-none">
                <ul className="menu menu-horizontal items-center px-1 hidden sm:flex gap-5">
