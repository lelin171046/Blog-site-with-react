...
const Content = () => {
    ...
    const {title, description, cover_image, published_at, id,tags, body_html} = blog;
    return (
        <div to={`/blog/${id}`} className=" mx-auto group border-2 border-opacity-30 p-2 hover:no-underline focus:no-underline dark:bg-gray-50">
